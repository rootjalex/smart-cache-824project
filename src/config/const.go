...
const NUM_PATTERNS_SMALL = NFILES_SMALL / MAX_PATTERN_LENGTH // 33.3333333333
const NUM_PATTERNS_MED = NFILES_MED / MAX_PATTERN_LENGTH
const PATTERN_REPLICATION_SMALL = NUM_PATTERNS_SMALL * 10 // 333.3333333
const PATTERN_REPLICATION_MED = NUM_PATTERNS_MED * 10
