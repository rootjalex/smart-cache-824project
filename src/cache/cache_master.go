...
func StartTask(clients []*client.Client, cacheType CacheType, cacheSize int, numCaches int, replication int, datastore *datastore.DataStore, ms int) (map[int]*Cache, *Hash) {
    // k: number of caches
